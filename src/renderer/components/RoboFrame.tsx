...
export default function RoboFrame(
  props: { style?: React.CSSProperties; className?: string } | undefined
) {
  ...
  return (
    <FrameSVG paths={paths} style={props?.style} className={props?.className} />
  );
}
